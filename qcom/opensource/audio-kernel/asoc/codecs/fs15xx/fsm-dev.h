...
// #define CONFIG_FSM_FS1758
#define CONFIG_FSM_FS1599

/* VERSION INFORMATION */
#define FSM_CODE_VERSION "v4.0.5"
#define FSM_CODE_DATE    "20211110"
#define FSM_GIT_BRANCH   ""
#define FSM_GIT_COMMIT   ""

#define FSM_DRV_NAME     "fs15xx"
#define FSM_FW_NAME      "fs15xx.fsm"
...
#define FSM_SCENE_CALIB_RE25       16
#define FSM_SCENE_CALIB_F0         17
#define FSM_SCENE_MAX              (17) // TODO
...
enum fsm_mute_type {
	FSM_UNMUTE = 0, // dac unmute and enable ts
	FSM_AMP_MUTE, // amp off
	FSM_DAC_MUTE, // dac mute and disable ts
};
...
struct fsm_ops {
	...
	int (*set_mute)(struct fsm_dev *, int mute);
	...
	int (*get_livedata)(struct fsm_dev *, int *data);
};
